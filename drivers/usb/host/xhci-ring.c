...
/*
 * Single-step SET_FEATURE for the USB2 embedded-host electrical test,
 * called from xhci-hub.c. Restored from the 5.4 tree, which the merge
 * dropped along with the rest of the file's vendor hunks.
 */
