...
static const struct qcom_apcs_ipc_data apcs_offset8_data = {
	.offset = 8, .clk_name = NULL
};

static const struct qcom_apcs_ipc_data apcs_offset0_data = {
	.offset = 0, .clk_name = NULL
};
...
static const struct of_device_id qcom_apcs_ipc_of_match[] = {
	...
	{ .compatible = "qcom,sdxlemur-apcs-gcc", .data = &apcs_offset8_data },
	{ .compatible = "qcom,scuba-apcs-hmss-global", .data = &apcs_offset8_data },
	{ .compatible = "qcom,monaco-apcs-hmss-global", .data = &apcs_offset8_data },
	{ .compatible = "qcom,sm8150-spcs-global", .data = &apcs_offset0_data },
	{ .compatible = "qcom,sdxnightjar-apcs-gcc", .data = &apcs_offset0_data },
	{}
};
