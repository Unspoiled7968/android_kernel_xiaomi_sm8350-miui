...
/*
 * CAF/Xiaomi downstream DMA attributes (kept for vendor drivers).
 * DMA_ATTR_FORCE_COHERENT/DMA_ATTR_FORCE_NON_COHERENT moved to free bits
 * because ACK uses (1UL << 14)/(1UL << 15) for DMA_ATTR_SYS_CACHE_ONLY*.
 */
...
#define DMA_ATTR_FORCE_COHERENT		(1UL << 18)
#define DMA_ATTR_FORCE_NON_COHERENT	(1UL << 19)
