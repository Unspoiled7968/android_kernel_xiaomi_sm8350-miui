	...
	struct cam_tfe_irq_evt_payload       *evt_payload)
{
	...
	CAM_INFO(CAM_ISP,
		...
		(long long)(top_priv->error_ts.tv_nsec / NSEC_PER_USEC),
		top_priv->sof_ts.tv_sec,
		(long long)(top_priv->sof_ts.tv_nsec / NSEC_PER_USEC),
		top_priv->epoch_ts.tv_sec,
		(long long)(top_priv->epoch_ts.tv_nsec / NSEC_PER_USEC),
		top_priv->eof_ts.tv_sec,
		(long long)(top_priv->eof_ts.tv_nsec / NSEC_PER_USEC));
